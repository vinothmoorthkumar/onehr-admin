...
@Component({
  selector: 'app-home',
  templateUrl: './our-services-job-classification.component.html',
  styleUrls: ['./our-services-job-classification.component.css']
})
export class OurServiceJobClassComponent implements OnInit {
